...
function PPLG2() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        // Fetch galleries
        const galleriesResponse = await api.get(`/galleries/category/4`);
        setGalleries(galleriesResponse.data.data.galleries || []);

        // Fetch top projects
        const topProjectsResponse = await api.get("/top-projects/category/4");
